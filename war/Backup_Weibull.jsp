...
<table class='tbl'>
<tr>
<th class='head'>α</th><th class='head'>β</th>
</tr>

<% 
	double alpha = backup.getAlpha();
	double beta = backup.getBeta();
%>	
	<tr>
	<td class='<%=cls%>' width='120' style='text-align:center'><%=alpha%></td>
	<td class='<%=cls%>' width='120' style='text-align:center'><%=beta%></td>
	</tr>
</table>	
